...
void stringToAscii(unsigned char *s){
  unsigned char *ptr = s;
//  char finalRes[256]="";
  char *finalRes = malloc(sizeof(char)*256);
...
void stringToReverseAscii(unsigned char *s){
  unsigned char *ptr = s;
  char finalRes[256]="";
...
//void stringToEncodedAscii(unsigned char *s){
char *stringToEncodedAscii(unsigned char *s){
  unsigned char *ptr = s;
  char finalRes[256]="";
